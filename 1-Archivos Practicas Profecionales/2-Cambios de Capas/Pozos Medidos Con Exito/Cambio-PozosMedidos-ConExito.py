...
input_kml_file = 'doc.kml' # Mantener el nombre que el usuario intentó usar
output_kml_file = 'medidos_con_exito_2025_ordenados.kml' # Nuevo nombre de salida más específico
